        ...
        std::string end_link)
{
    ...
    sub_car_imu_              = nh_.subscribe(topic_car_imu, 5, 
      &Impedance::imu_car_callback, this,ros::TransportHints().reliable().tcpNoDelay());    
...
//    first order Low pass filter
    ...
    if (Wf_ == 30){
      bq1.set( 1.10050e+00, -8.99500e-01, 0.00000e+00, -1.00000e+00, 0.00000e+00 ); // 150 Hz digital s+30/s
      bq2.set( 1.10050e+00, -8.99500e-01, 0.00000e+00, -1.00000e+00, 0.00000e+00 ); // 150 Hz digital s+30/s
      bq3.set( 1.10050e+00, -8.99500e-01, 0.00000e+00, -1.00000e+00, 0.00000e+00 ); // 150 Hz digital s+30/s
      bq4.set( 1.10050e+00, -8.99500e-01, 0.00000e+00, -1.00000e+00, 0.00000e+00 ); // 150 Hz digital s+30/s
      bq5.set( 1.10050e+00, -8.99500e-01, 0.00000e+00, -1.00000e+00, 0.00000e+00 ); // 150 Hz digital s+30/s
      bq6.set( 1.10050e+00, -8.99500e-01, 0.00000e+00, -1.00000e+00, 0.00000e+00 ); // 150 Hz digital s+30/s
    }
    else if (Wf_ == 6){
      bq1.set(  1.00300e+00, -9.97000e-01, 0.00000e+00, -1.00000e+00, 0.00000e+00 ); // 1000 Hz digital 6/(s+6)
      bq2.set(  1.00300e+00, -9.97000e-01, 0.00000e+00, -1.00000e+00, 0.00000e+00 ); // 1000 Hz digital 6/(s+6)
      bq3.set(  1.00300e+00, -9.97000e-01, 0.00000e+00, -1.00000e+00, 0.00000e+00 ); // 1000 Hz digital 6/(s+6)
      bq4.set(  1.00300e+00, -9.97000e-01, 0.00000e+00, -1.00000e+00, 0.00000e+00 ); // 1000 Hz digital 6/(s+6)
      bq5.set(  1.00300e+00, -9.97000e-01, 0.00000e+00, -1.00000e+00, 0.00000e+00 ); // 1000 Hz digital 6/(s+6)
      bq6.set(  1.00300e+00, -9.97000e-01, 0.00000e+00, -1.00000e+00, 0.00000e+00 ); // 1000 Hz digital 6/(s+6)
    }
    else if (Wf_ == 90){
      bq1.set( 2.31656e-01, 2.31656e-01, 0.00000e+00, -5.36688e-01, 0.00000e+00 ); // 150 Hz digital 60/(s+60)
      bq2.set( 2.31656e-01, 2.31656e-01, 0.00000e+00, -5.36688e-01, 0.00000e+00 ); // 150 Hz digital 60/(s+60)
      bq3.set( 2.31656e-01, 2.31656e-01, 0.00000e+00, -5.36688e-01, 0.00000e+00 ); // 150 Hz digital 60/(s+60)
      bq4.set( 2.31656e-01, 2.31656e-01, 0.00000e+00, -5.36688e-01, 0.00000e+00 ); // 150 Hz digital 60/(s+60)
      bq5.set( 2.31656e-01, 2.31656e-01, 0.00000e+00, -5.36688e-01, 0.00000e+00 ); // 150 Hz digital 60/(s+60)
      bq6.set( 2.31656e-01, 2.31656e-01, 0.00000e+00, -5.36688e-01, 0.00000e+00 ); // 150 Hz digital 60/(s+60)
      
    }
    else {
      bq1.set( 1.0, 0.00000e+00, 0.00000e+00, 0.00000e+00, 0.00000e+00  );
      bq2.set( 1.0, 0.00000e+00, 0.00000e+00, 0.00000e+00, 0.00000e+00  );
      bq3.set( 1.0, 0.00000e+00, 0.00000e+00, 0.00000e+00, 0.00000e+00  );
      bq4.set( 1.0, 0.00000e+00, 0.00000e+00, 0.00000e+00, 0.00000e+00  );
      bq5.set( 1.0, 0.00000e+00, 0.00000e+00, 0.00000e+00, 0.00000e+00  );
      bq6.set( 1.0, 0.00000e+00, 0.00000e+00, 0.00000e+00, 0.00000e+00  );
    }
    ...
    filename = std::string(homeDir) + "/data/data_" + timestamp + ".csv";
}
...
void Impedance::imu_car_callback(const sensor_msgs::ImuConstPtr msg){
  car_acc_ << msg->linear_acceleration.x, msg->linear_acceleration.y, msg->linear_acceleration.z-9.81, 0, 0, 0;//, msg->linear_acceleration[0];
}


void Impedance::imp_param_update_callback(const std_msgs::Float64MultiArray::ConstPtr msg){
  std::cout << "666666666666666666" <<msg->data[0] << std::endl;
  if(msg->data[0] < 0 && msg->data[1] < 0){
    Impedance_D[1] = -msg->data[0];
    Impedance_K[1] = -msg->data[1];
  }
}
...
void Impedance::compute_impedance(bool flag)
{
    if(flag)
    {
        ...
        R_car_ = R_car_.RPY(car_angle(0), car_angle(1), car_angle(2));  
        //std::cout << R_car_.data[0] << "," << R_car_.data[1] << "," << R_car_.data[2] << std::endl 
        //          << R_car_.data[3] << "," << R_car_.data[4] << "," << R_car_.data[5] << std::endl
        //          << R_car_.data[6] << "," << R_car_.data[7] << "," << R_car_.data[8] << std::endl;
        
        Matrix6d diagRR;
        diagRR << R_car_.data[0], R_car_.data[1], R_car_.data[2], 0, 0, 0,
                  R_car_.data[3], R_car_.data[4], R_car_.data[5], 0, 0, 0,
                  R_car_.data[6], R_car_.data[7], R_car_.data[8], 0, 0, 0,
                  0, 0, 0, R_car_.data[0], R_car_.data[1], R_car_.data[2],
                  0, 0, 0, R_car_.data[3], R_car_.data[4], R_car_.data[5],
                  0, 0, 0, R_car_.data[6], R_car_.data[7], R_car_.data[8];
        
        KDL::JntArrayVel Jnt_Vel;
        Jnt_Vel = KDL::JntArrayVel(Jnt_Pos_State, Jnt_Vel_State);
        jnt_to_jac_solver_->JntToJac(Jnt_Pos_State, J_);
        J_.data = diagRR * J_.data;
        //std::cout << " J_: "<< J_.data << std::endl;
    	// computing Inertia, Coriolis andcar_angle Gravity matrices
        ...
        Jnt_Desired_Vel_State.data = J_.data.inverse() * (Cart_ee_Ref_Twist - car_twist_);
        id_solver_->JntToCoriolis(Jnt_Pos_State, Jnt_Desired_Vel_State, C_); // C \dot{x}_d        
        
        KDL::JntArray feedforward_cmd_(this->kdl_chain_.getNrOfJoints());

        KDL::JntArray pid_cmd_(this->kdl_chain_.getNrOfJoints());
        KDL::JntArray cg_cmd_(this->kdl_chain_.getNrOfJoints());
        KDL::JntArrayVel Jnt_dVel;
        Jnt_dVel = KDL::JntArrayVel(Jnt_Pos_State, Jnt_Desired_Vel_State);
        jnt_to_jac_dot_solver_->JntToJacDot(Jnt_dVel, J_dot_q_dot_);
        Vector6d jqqd;
        jqqd << J_dot_q_dot_.vel.data[0],J_dot_q_dot_.vel.data[1] ,J_dot_q_dot_.vel.data[2], J_dot_q_dot_.rot.data[0], J_dot_q_dot_.rot.data[1], J_dot_q_dot_.rot.data[2];
        
        feedforward_cmd_.data = M_.data * J_.data.inverse() * (-car_acc_ + jqqd); // (- car_acc_ + jqqd);
        ...
        pid_cmd_(0) = bqc1.step(pid_cmd_(0)); // 1/(1 - Gf(s)) filtering
        pid_cmd_(1) = bqc2.step(pid_cmd_(1)); 
        pid_cmd_(2) = bqc3.step(pid_cmd_(2));
        pid_cmd_(3) = bqc4.step(pid_cmd_(3));
        pid_cmd_(4) = bqc5.step(pid_cmd_(4));
        pid_cmd_(5) = bqc6.step(pid_cmd_(5));
        Jnt_Toq_Cmd_.data = J_.data.transpose() * pid_cmd_.data; // M_.data * J_.data.inverse() * pid_cmd_.data; 
        Jnt_Toq_Cmd_.data += M_.data * J_.data.inverse() * Cart_ee_Ref_Acc; 
        //std::cout<< "VIC_output: " << Jnt_Toq_Cmd_.data.transpose() << std::endl;
        KDL::JntArray ude_cmd_(this->kdl_chain_.getNrOfJoints());
        ude_cmd_.data = - Wf_ * 0.001 * M_.data * Jnt_Vel_State.data;   // s Gf(s) / (1 - Gf(s)) filtering Jnt_Vel_State
        ude_cmd_.data += Wf_ * 0.001 * M_.data * J_.data.inverse() * (Cart_ee_Ref_Twist);
        
        KDL::Add(Jnt_Toq_Cmd_,ude_cmd_,Jnt_Toq_Cmd_);
        std::cout << "FF_torque: "<< feedforward_cmd_.data.transpose() << std::endl;
        std::cout<< "UDE_output: " << Jnt_Toq_Cmd_.data.transpose() << std::endl;
        // =================================================c and g =====================================================
        KDL::Add(Jnt_Toq_Cmd_,cg_cmd_,Jnt_Toq_Cmd_);
        //std::cout << "Joint torque: "<< Jnt_Toq_Cmd_.data.transpose() << std::endl;
        std::cout << " CG_torque: "<< cg_cmd_.data.transpose() << std::endl;
        
        KDL::Add(Jnt_Toq_Cmd_,feedforward_cmd_,Jnt_Toq_Cmd_);
        ...
        file << "cart_ee_Ref_pos," << t << "," << Cart_ee_Ref_Pose(0) << "," << Cart_ee_Ref_Pose(1) << "," << Cart_ee_Ref_Pose(2)
                                    << "," << Cart_ee_Ref_Pose(3)<< "," << Cart_ee_Ref_Pose(4) << "," << Cart_ee_Ref_Pose(5) << std::endl;
        file << "Cart_ee_Pos," << t << "," << Cart_Pos_State(0) << "," << Cart_Pos_State(1) << "," << Cart_Pos_State(2)
                                    << "," << Cart_Pos_State(3)<< "," << Cart_Pos_State(4) << "," << Cart_Pos_State(5) << std::endl;    
        file << "Cart_ee_Ref_Twist," << t << "," << Cart_ee_Ref_Twist(0) << "," << Cart_ee_Ref_Twist(1) << "," << Cart_ee_Ref_Twist(2)
                                    << "," << Cart_ee_Ref_Twist(3)<< "," << Cart_ee_Ref_Twist(4) << "," << Cart_ee_Ref_Twist(5) << std::endl;    
        file << "Cart_Vel_State,"  << t << "," <<  Cart_Vel_State(0) << "," << Cart_Vel_State(1) << "," << Cart_Vel_State(2)
                                    << "," << Cart_Vel_State(3)<< "," << Cart_Vel_State(4) << "," << Cart_Vel_State(5) << std::endl;                                                                    
        file << "Ext_Wrench," << t << "," << Ext_Wrench.force(0) << "," << Ext_Wrench.force(1) << "," << Ext_Wrench.force(2) << "," 
                                  << Ext_Wrench.torque(0) << "," << Ext_Wrench.torque(1) << "," << Ext_Wrench.torque(2) << std::endl;
        file << "Ref_Wrench," << t << "," << Ref_Wrench.force(0) << "," << Ref_Wrench.force(1) << "," << Ref_Wrench.force(2) << "," 
                                  << Ref_Wrench.torque(0) << "," << Ref_Wrench.torque(1) << "," << Ref_Wrench.torque(2) << std::endl;
        file << "final_output," << t << "," << Jnt_Toq_Cmd_.data[0] << "," << Jnt_Toq_Cmd_.data[1] << "," << Jnt_Toq_Cmd_.data[2]
                                    << "," << Jnt_Toq_Cmd_.data[3]<< "," << Jnt_Toq_Cmd_.data[4] << "," << Jnt_Toq_Cmd_.data[5] << std::endl; 
        file << "car_pose," << t << "," << car_position_(0) << "," << car_position_(1) << "," << car_position_(2) << ","
                                << car_angle(0) << "," << car_angle(1) << "," << car_angle(2) << std::endl;  
        file << "car_twist," << t << "," << car_twist_(0) << "," << car_twist_(1) << "," << car_twist_(2) << ","
                                << car_twist_(3) << "," << car_twist_(4) << "," << car_twist_(5) << std::endl;  
        file << "Impedance_Kf, " << t << "," << Impedance_Kf[0] << ", " << Impedance_Kf[1] << ", " << Impedance_Kf[2] << ", " 
                                  << Impedance_Kf[3] << ", " << Impedance_Kf[4] << ", " << Impedance_Kf[5] << std::endl;  
        file << "Impedance_K, " << t << "," << Impedance_K[0] << ", " << Impedance_K[1] << ", " << Impedance_K[2] << ", " 
                                  << Impedance_K[3] << ", " << Impedance_K[4] << ", " << Impedance_K[5] << std::endl;  
        file << "Impedance_D, " << t << "," << Impedance_D[0] << ", " << Impedance_D[1] << ", " << Impedance_D[2] << ", " 
        ...
        std::cout << "Ref_Wrench: " << Ref_Wrench.force(0) << "," << Ref_Wrench.force(1) << "," << Ref_Wrench.force(2) << "," 
                                  << Ref_Wrench.torque(0) << "," << Ref_Wrench.torque(1) << "," << Ref_Wrench.torque(2) << std::endl;
        std::cout << "final_output:" << Jnt_Toq_Cmd_.data.transpose() << std::endl;
        ...
        if(Cart_Pos_State(0) >= 2.2 && Cart_Pos_State(0) < 8.2 ){
            VIC_state = true;    VIC_state2 = false;
        }
        if(Cart_Pos_State(0) >= 8.2){
            VIC_state = false;
            VIC_state2 = true;    
        }

        VIC_state = false; VIC_state2 = false;

        double kf = 5.0;

        if(VIC_state){
            if( Impedance_Kf[1] > -kf){
                Impedance_Kf[1] -= kf/1000.0;
            }
            if( Impedance_K[1] > 100 ){
                Impedance_K[1] -= (100)/1000.0;
                // ================================================ passivity preservation ======================================
                if (Cart_Vel_State(1) != 0){
                    Jnt_Toq_Cmd_.data(1) -= 0.5 / Cart_Vel_State(1) * 
                             (Cart_ee_Ref_Pose(1) - Cart_Pos_State(1)) * (-1) * (Cart_ee_Ref_Pose(1) - Cart_Pos_State(1));
                }
            }
        }
        
        if(VIC_state2){
            if( Impedance_Kf[1] < 0.0){
                Impedance_Kf[1] = Impedance_Kf[1] + kf/1000.0;
            }
            if( Impedance_K[1] < 200){
                Impedance_K[1] =  Impedance_K[1] + (100)/1000.0;
                if (Cart_Vel_State(1) != 0){
                    Jnt_Toq_Cmd_.data(1) -= 0.5 / Cart_Vel_State(1) * 
                             (Cart_ee_Ref_Pose(1) - Cart_Pos_State(1)) * (1) * (Cart_ee_Ref_Pose(1) - Cart_Pos_State(1));
                }
